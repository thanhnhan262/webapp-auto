...
public class Const {
    public static final String URL = "https://staging.tinyserver.info/auth";
    public static final String LOGIN_USERNAME = "123@abc.com";
    public static final String LOGIN_PASSWORD = "Pass1234";
